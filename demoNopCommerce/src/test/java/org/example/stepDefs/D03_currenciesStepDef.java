...
public class D03_currenciesStepDef {
    ...
    public void userShouldFoundAllProductsPricesInEURO() {
        ...
        int numberOfProducts = homePage.productPrices().size();  //كدا هو خزن الل
        for (int i = 0; i < numberOfProducts; i++) {
//            soft.assertEquals(homePage.productPrices().get(i).getText().substring(0,1),"€","One Of Products Prices In Different Currency From The Selected One");
//            soft.assertAll();
